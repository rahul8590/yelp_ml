...
% Dude, I have more idea. Do yelp suggest restraunts if you visit another restraunts ? We can do this just from reviews. Treat is matrix-factorization with restraunts (as items) and words mentioned in the reviews (as users) .%
